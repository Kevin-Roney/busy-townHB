      ...
      <div className="fight">
        <div className="monster">
          ...
          <div className='buttons'>
            ...
            <button onClick={handleAlienGrow}>Oh no! The alien is gobblin up all the electricity!</button>
            {/* when you click this button, the lizard's size in state should go down by one */}
            <button onClick={handleLizardShrink}>Amazing! The alien zapped the lizard!</button>
          </div>
        </div>
        <div className="monster">
          ...
          <div className="buttons">
            ...
            <button onClick={handleLizardGrow}>Yegads! The lizard is ramping up to its final form!</button>
            {/* when you click this button, the alien's size in state should go up by one */}
            <button onClick={handleAlienShrink}>Oh my! The lizard chomped down on the alien!</button>
          </div>
        </div>
      </div>
